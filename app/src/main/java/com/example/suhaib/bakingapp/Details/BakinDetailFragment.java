...
/**
 * A fragment representing a single Bakin detail screen.
 * This fragment is either contained in a {@link BakinListActivity}
 * in two-pane mode (on tablets) or a {@link BakinDetailActivity}
 * on handsets.
 */
public class BakinDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.bakin_detail)).setText(mItem.details);
        }
